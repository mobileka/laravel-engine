...
Route::get('admin/login', array('as' => 'auth_admin_default_login', 'uses' => 'auth::admin.default@login'));
Route::post('admin/login', array('as' => 'auth_admin_default_login', 'uses' => 'auth::admin.default@login'));
Route::get('admin/logout', array('as' => 'auth_admin_default_logout', 'uses' => 'auth::admin.default@logout'));
