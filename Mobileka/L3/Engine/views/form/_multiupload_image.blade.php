<div class="thumbnail thumbnail-plupload {{ (isset($component) && $component->featuredImageSelector && $component->row->{$component->featuredImageSelector} == $file->id) ? 'featured-image' : '' }}">
